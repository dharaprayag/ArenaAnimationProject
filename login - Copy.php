<?php include("header.php");?>
    ...
    <body>
          ...
          <div class="container">
              <div class="row">
                <div class="col-sm-4">
                    <img src="lib/5.png" class="rounded" height="800" width="360"> 
                  ...
                  <div class="signinbutton">
                    ...
                    <button type="button" class="btn btn-link btn-outline-light text-light"><a href="registeredsigninpage.html">Sign in</a></button>
                    
                  </div>               
                </div>
                <div class="col-sm-8">
                    <img src="lib/5.png" class="rounded" height="800" width="733">
                        <div class="signupform">
                            <p class="eventregistrationform">Event Registration Form</p>
                            <div class="tableform">
                                <table width="400" height="650" cellspacing="0" cellpadding="0">
